...
var incomingHDPrivateKey = new bitcore.HDPrivateKey(config.get('btc.wallet.incoming.privateKey'))
var outgoingHDPublicKey = new bitcore.HDPublicKey(config.get('btc.wallet.outgoing.publicKey'))
