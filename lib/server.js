...
var doRegister = (req, res) => {
  // Sanitize
  if (!docproof.isValidDigest(req.params.hash)) {
...
app.post('/confirmed/:magicNumber/:address', function (req, res) {
...
app.post('/unconfirmed/:magicNumber/:address', function (req, res) {
  var requestAddress = req.params.address
